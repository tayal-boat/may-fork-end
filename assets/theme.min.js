...
`;
  ...
  var ProductMeta = class extends HTMLElement {
    ...
    _updatePrices(variant) {
      ...
      let productPrices2 = this.querySelector("[data-product-price-list-2]"), currencyFormat = window.themeVariables.settings.currencyCodeEnabled ? window.themeVariables.settings.moneyWithCurrencyFormat : window.themeVariables.settings.moneyFormat;
      if (!productPrices || !productPrices2 ) {
        return;
      }
      if (!variant) {
        productPrices.style.display = "none";
        productPrices2.style.display = "none";
      } else {
        productPrices.innerHTML = "";
        productPrices2.innerHTML = "";
        if (variant["compare_at_price"] > variant["price"]) {
          ...
          productPrices2.innerHTML += `<span class="price price--highlight ${this.priceClass}"><span class="visually-hidden">${window.themeVariables.strings.productSalePrice}</span>${formatMoney(variant["price"], currencyFormat)}</span>`;
          productPrices2.innerHTML += `<span class="price price--compare"><span class="visually-hidden">${window.themeVariables.strings.productRegularPrice}</span>${formatMoney(variant["compare_at_price"], currencyFormat)}</span>`;
        } else {
          ...
          productPrices2.innerHTML += `<span class="price ${this.priceClass}"><span class="visually-hidden">${window.themeVariables.strings.productSalePrice}</span>${formatMoney(variant["price"], currencyFormat)}</span>`;
        }
