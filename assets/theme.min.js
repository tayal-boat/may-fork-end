...
(() => {
  ...
  !(function () {
            ...
            a &&
              t(o).then(function () {
                ...
                for (var t = 0, o = a.length; t < o; t++)
                  i.hasAttribute(a[t]) &&
                    r({ target: i, attributeName: a[t], oldValue: null });
              }),
            i
          );
        };
    ...
    var o = "querySelectorAll",
      ...
      p = function (t) {
          ...
          a = function (n, r) {
            ...
            if (r)
              for (
                ...
                a.call(n, (o = m[s])) &&
                  (e.has(n) || e.set(n, new c()),
                  (i = e.get(n)).has(o) || (i.add(o), t.handle(n, r, o)));
            else
              e.has(n) &&
                ((i = e.get(n)),
                e.delete(n),
          ...
          v = (function (t, e, o) {
            var a = function e(i, o, a, s, u) {
                for (var l = 0, c = i.length; l < c; l++) {
                  ...
                  (u || r in f) &&
                    (s
                      ? o.has(f) || (o.add(f), a.delete(f), t(f, s))
                      : a.has(f) || (a.add(f), o.delete(f), t(f, s)),
                    u || e(f[r]("*"), o, a, s, n));
                }
              },
              s = new (o || MutationObserver)(function (t) {
                for (
                  var e = new Set(), r = new Set(), i = 0, o = t.length;
                  i < o;
                  i++
                ) {
                  var s = t[i],
        ...
        return (
          b &&
            (u.prototype.attachShadow = function (t) {
              var e = b.call(this, t);
              return v.add(e), e;
            }),
          m.length && p(g[o](m)),
          {
            ...
            flush: function () {
              for (var t = v.takeRecords(), e = 0, n = t.length; e < n; e++)
                p(h.call(t[e].removedNodes, d), !1),
                  p(h.call(t[e].addedNodes, d), !0);
            },
            observer: v,
            parse: p,
          }
      ...
      O = function (t) {
        for (var e = R(t), n = [], r = e.length, i = 0; i < r; i++)
          (n[i] = t[e[i]]), delete t[e[i]];
        return function () {
    ...
    if (D) {
      ...
      A(self, "customElements", {
        ...
        A((I.prototype = x.prototype), "constructor", { value: I }),
        A(self, "HTMLElement", { configurable: !0, value: I }),
        A(g, "createElement", {
          configurable: !0,
          value: function (t, e) {
            var n = e && e.is,
      ...
      try {
        ...
        var K = "extends-li";
        self.customElements.define("extends-li", $, { extends: "li" }),
          (D = g.createElement("li", { is: K }).outerHTML.indexOf(K) < 0);
    ...
    if (D) {
      var Q = function (t) {
        ...
        pt = p({
          ...
          handle: function (t, e) {
            it.has(t) &&
              (e ? ot.add(t) : ot.delete(t), ft.length && Q.call(ft, t));
          },
        }).parse,
        mt = function (t) {
          if (!st.has(t)) {
      ...
      M(self)
        ...
        .forEach(function (t) {
          ...
          A((n.prototype = e.prototype), "constructor", { value: n }),
            A(self, t, { value: n });
        }),
        A(g, "createElement", {
          configurable: !0,
        ...
        A(J, "get", { configurable: !0, value: dt }),
        A(J, "whenDefined", { configurable: !0, value: mt }),
        A(J, "define", {
          configurable: !0,
          value: function (t, e, n) {
            ...
            var r,
              i = n && n.extends;
            at.set(e, i ? { is: t, tag: i } : { is: "", tag: t }),
              i
                ? ((r = "".concat(i, '[is="').concat(t, '"]')),
                  ut.set(r, e.prototype),
                  lt.set(t, e),
                  ft.push(r))
                : (et.apply(J, arguments), ct.push((r = t))),
              mt(t).then(function () {
                i
                  ? (ht(g.querySelectorAll(r)), ot.forEach(Q, [r]))
                  : pt(g.querySelectorAll(r));
              }),
              st.get(t)._(e);
          },
        });
    ...
    (function () {
      ...
      !(function (t, e) {
        ...
        function u(t) {
          ...
          var r = w.exec(t);
          return r
            ? a(Number(r[1]), { start: h, middle: p, end: m }[r[2]])
            : g[t] || d;
        }
        function l(t, e, n) {
          if (null == e) return T;
        ...
        (e = {}),
        ((t = n).isDeprecated = function (t, n, r, i) {
          var o = i ? "are" : "is",
            a = new Date(),
            s = new Date(n);
          return (
        ...
        (function () {
          ...
          !(function (t, e, n) {
            ...
            (function (t, e) {
              ...
              for (var u in ((r.prototype = {
                ...
                set cssText(t) {
                  ...
                  for (n = 0; n < this._surrogateStyle.length; n++)
                    e[this._surrogateStyle[n]] = !0;
                  for (var r in e)
              ...
              (t.apply = function (e, i, o) {
                (function (t) {
                  ...
                  e.style._set(t.propertyName(i), o);
              }),
            ...
            (i = r),
            (window.Element.prototype.animate = function (t, e) {
              var n = "";
              return (
                e && e.id && (n = e.id),
                i.timeline._play(i.KeyframeEffect(this, t, e, n))
              );
            }),
            (function (t, e) {
            ...
            (function (t, e) {
              var n = (function () {
                ...
                return function (e, n, r, i, o) {
                  ...
                  for (
                    r[2] && ((m[2][1] = r[2]), (a = t(a, m))),
                      r[1] && ((m[2][1] = 0), (m[2][0] = r[0]), (a = t(a, m))),
                      r[0] && ((m[2][0] = 0), (m[1][0] = r[0]), (a = t(a, m))),
                      s = 0;
                    s < 3;
                    s++
                  )
              ...
              (t.composeMatrix = n),
                (t.quat = function (e, n, r) {
                  ...
                  if (
                    ...
                    for (
                      var a = Math.acos(i),
                        s = (1 * Math.sin(r * a)) / Math.sqrt(1 - i * i),
                        u = 0;
                      u < 4;
                      u++
                    )
            ...
            (function (t, e, n) {
                  ...
                  r.forEach(function (e) {
                    e._tick(t, n),
                      e._inEffect
                        ...
                        : (i.push(e._effect), e._unmarkTarget()),
                      e._needsTick && (f = !0);
              ...
              (e.restart = function () {
                return (
                  f ||
                    ((f = !0), requestAnimationFrame(function () {}), (d = !0)),
                  d
                );
              }),
                ...
                return function (o) {
                  ...
                  return (
                    y > 1e-4
                      ...
                      : h[1][1] > h[2][2]
                      ? ((v = 2 * Math.sqrt(1 + h[1][1] - h[0][0] - h[2][2])),
                        (b = [
                          (h[0][1] + h[1][0]) / v,
                          0.25 * v,
                          (h[1][2] + h[2][1]) / v,
                      ...
                      : ((v = 2 * Math.sqrt(1 + h[2][2] - h[0][0] - h[1][1])),
                        (b = [
                          (h[0][2] + h[2][0]) / v,
                          (h[1][2] + h[2][1]) / v,
                          0.25 * v,
            ...
            (function (t, e) {
              ...
              (t.clamp = r),
                ...
                t.addPropertiesHandler(i, o(0, 1 / 0), [
                  "border-image-width",
                  "line-height",
                ]),
                t.addPropertiesHandler(i, o(0, 1), [
                  "opacity",
                ...
                return [
                  ...
                  function (e) {
                    if (e[3])
                      for (var n = 0; n < 3; n++)
                        e[n] = Math.round(
                          ((r = e[n] / e[3]), Math.max(0, Math.min(255, r)))
                        );
                    var r;
                    return (
            ...
            (function (t, e) {
              ...
              function i(e) {
                ...
                for (
                  ...
                  if ((i.push({ t: a, d: h }), r.lastIndex == e.length))
                    return i;
                }
              }
              function o(t) {
                  ...
                  if (e.length != n.length) {
                    ...
                    for (o = 0; o < e.length; o++) {
                      ...
                      if (
                        ...
                        if (b == y) l = b;
                        else if (T[2] && x[2] && s(b) == s(y))
                          (l = s(b)), (_ = T[2](_)), (w = x[2](w));
                        else {
                          if (!T[1] || !x[1] || u(b) != u(y)) {
                            if (!r) return;
                            (m = [(E = a(e, n))[0]]),
      ...
      var n,
        ...
        x = function (e, n, o, a) {
          ...
          if (
            ...
            (a.y = i),
            h.useJquery &&
              ((s = jQuery.Event(n, { originalEvent: o })),
              jQuery(e).trigger(s, a)),
            s.initEvent)
          ) {
          ...
          if (b(t) && !w(t))
            if (((n = void 0), "mouseup" === t.type && p)) p = !1;
              ...
              if (
                (clearTimeout(l),
                clearTimeout(c),
                m <= -h.swipeThreshold && e.push("swiperight"),
                m >= h.swipeThreshold && e.push("swipeleft"),
                d <= -h.swipeThreshold && e.push("swipedown"),
                d >= h.swipeThreshold && e.push("swipeup"),
                e.length)
              ) {
                for (var g = 0; g < e.length; g++) {
                  var v = e[g];
                  x(t.target, v, t, {
                    distance: { x: Math.abs(m), y: Math.abs(d) },
                  });
                }
                E = 0;
              } else
                o >= r - h.tapPrecision &&
                  ...
                  a >= i - h.tapPrecision &&
                  a <= i + h.tapPrecision &&
                  s + h.tapThreshold - f >= 0 &&
                  (x(t.target, E >= 2 && u === t.target ? "dbltap" : "tap", t),
                  (u = t.target)),
    ...
    if (
      ...
      f
        ...
        : document.addEventListener(
            "mouseover",
            function (n) {
              if (performance.now() - e < l) return;
              const r = n.target.closest("a");
              if (!m(r)) return;
              r.addEventListener("mouseout", p, { passive: !0 }),
                (t = setTimeout(() => {
                  g(r.href), (t = void 0);
                }, c));
            },
  ...
  var v = (t) =>
    void 0 === t || "auto" === t || "instant" === t || "smooth" === t;
  function b(t, e) {
    (this.scrollLeft = t), (this.scrollTop = e);
  }
  var y = (t, e, n = "cannot convert to dictionary.") =>
      `Failed to execute '${t}' on '${e}': ${n}`,
    _ = (t, e, n) =>
      y(
        t,
        e,
    ...
    w = (t, e, n) => {
      ...
      return (
        t[i] ||
          !t[e] ||
          (null == (r = t[e]) ? void 0 : r.__isPolyfill) ||
          (t[i] = t[e]),
        t[i] || n
      );
    },
    ...
    x = () => "scrollBehavior" in window.document.documentElement.style,
    E = (t) => {
      Object.defineProperty(t, "__isPolyfill", { value: !0 });
    },
    S = (t, e) => {
      E(e),
        [
    ...
    P = (t) =>
      t.ownerDocument.scrollingElement || t.ownerDocument.documentElement,
    k = () => {
      var t, e, n;
      return null !=
        (n =
          null == (e = null == (t = window.performance) ? void 0 : t.now)
            ? void 0
            : e.call(t))
        ? n
        : window.Date.now();
    ...
    N = (t) => {
      const e = (k() - t.timeStamp) / (t.duration || 500);
      if (e > 1) return t.method(t.targetX, t.targetY), void t.callback();
      const n = (t.timingFunc || ((t) => 0.5 * (1 - Math.cos(Math.PI * t))))(e),
    ...
    A = (t) => (isFinite(t) ? Number(t) : 0),
    R = (t) => (e, n, r) => {
      const [i, o] = ((t) => t.window === t)(e)
          ? [P(e.document.documentElement), "Window"]
          : [e, "Element"],
        a = null != n ? n : {};
      if (!T(a)) throw new TypeError(y(t, o));
      if (!v(a.behavior)) throw new TypeError(_(t, o, a.behavior));
      "scrollBy" === t &&
        ((a.left = A(a.left) + i.scrollLeft), (a.top = A(a.top) + i.scrollTop)),
        ((t, e, n) => {
          var r, i;
          if (
            !((t) => {
              var e;
              return null != (e = t.isConnected)
                ? e
                : !(
                    t.ownerDocument &&
                    1 & t.ownerDocument.compareDocumentPosition(t)
                  );
            })(t)
          )
            return;
          const o = t.scrollLeft,
            a = t.scrollTop,
            s = A(null != (r = e.left) ? r : o),
            u = A(null != (i = e.top) ? i : a);
          if (s === o && u === a) return;
          const l = w(HTMLElement.prototype, "scroll", b),
            c = w(Object.getPrototypeOf(t), "scroll", l).bind(t);
          ...
          window.addEventListener("wheel", h, { passive: !0, once: !0 }),
            window.addEventListener("touchmove", h, { passive: !0, once: !0 }),
            N(d);
        })(i, a, r);
    },
    M = R("scroll"),
    ...
    H = (t) => {
      return (
        1 == (1 & C(I(t.writingMode), "rtl" !== t.direction, void 0, void 0)[0])
      );
    },
    W = (t, e, n, r, i, o, a) =>
      0 !== t
        ...
        ? 3
        : null,
    F = (t) => "visible" !== t && "clip" !== t,
    B = (t, e) =>
      (t.clientHeight < t.scrollHeight || t.clientWidth < t.scrollWidth) &&
      (F(e.overflowY) || F(e.overflowX) || t === P(t)),
    q = (t) => {
      ...
      if (null === n && null !== e) {
        ...
        if (9 === e.nodeType)
          return ((t) => {
            ...
            try {
              return (
                (null == (e = t.ownerDocument.defaultView)
                  ? void 0
                  : e.frameElement) || null
              );
            } catch {
    ...
    V = (t, e) => {
      var n, r, i;
      const o =
          null == (n = t.ownerDocument.defaultView) ? void 0 : n.visualViewport,
        [a, s, u, l] =
          t === P(t)
            ? [
                0,
                0,
                null != (r = null == o ? void 0 : o.width) ? r : t.clientWidth,
                null != (i = null == o ? void 0 : o.height)
                  ? i
                  : t.clientHeight,
              ]
    ...
    U = (t, e) => {
      ...
      const o = window.getComputedStyle(t),
        ...
        [u, l] = ((t, e, n) => {
          const [r, i, o] = C(e, n, t.block || "start", t.inline || "nearest");
          return [i, o].map((t, e) => {
            switch (t) {
              case "center":
                return 1;
      ...
      let [c, f, d, h] = ((t, e, n) => {
        const { top: r, right: i, bottom: o, left: a } = e,
          s = ((t) =>
            ["scroll-margin", "scroll-snap-margin"].filter(
              (e) => e in t.documentElement.style
            )[0])(t.ownerDocument);
        if (!s) return [r, i, o, a];
        const u = (t) => {
      ...
      for (let o = q(t); null !== o; o = q(o)) {
        if (r !== o.ownerDocument) {
          if (!(i = (r = o.ownerDocument).defaultView)) break;
          const { left: t, top: e } = o.getBoundingClientRect();
          (c += e), (f += t), (d += e), (h += t);
        }
        ...
        const a = o.getBoundingClientRect(),
          [s, p, m, g] = V(o, a),
          v = W(u, g, p, o.clientWidth, h, f, f - h),
          b = W(l, s, m, o.clientHeight, c, d, d - c),
          y = null === v ? 0 : j(v, h, f) - j(v, g, p),
          _ = null === b ? 0 : j(b, c, d) - j(b, s, m),
          w = H(t)
            ? z(y, -o.scrollWidth + o.clientWidth - o.scrollLeft, -o.scrollLeft)
            : z(y, -o.scrollLeft, o.scrollWidth - o.clientWidth - o.scrollLeft),
          T = z(_, -o.scrollTop, o.scrollHeight - o.clientHeight - o.scrollTop);
        n.push([
          o,
          {
            left: o.scrollLeft + w,
    ...
    $ = (t, e, n) => {
      const r = e || {};
      if (!v(r.behavior))
        throw new TypeError(_("scrollIntoView", "Element", r.behavior));
      U(t, r).forEach(([t, e]) => {
        O(t, e, n);
      });
    },
    K = (t, e) => (n) => {
      if (x()) return;
      const r = { scroll: M, scrollTo: L, scrollBy: D }[t];
      e(t, function () {
        const t = arguments;
    ...
    X = (K("scroll", S), K("scrollTo", S)),
    Y = K("scrollBy", S),
    G = (t, e) => {
      E(e), w(window, t), (window[t] = e);
    };
  K("scroll", G), K("scrollTo", G), K("scrollBy", G);
  function Q(t) {
    $(this, { block: null == t || t ? "start" : "end", inline: "nearest" });
  }
  ((t) => {
    if (x()) return;
    const e = w(window.HTMLElement.prototype, "scrollIntoView", Q);
    S("scrollIntoView", function () {
      const n = arguments,
        r = n[0];
      1 === n.length && T(r) ? $(this, r, t) : e.apply(this, n);
    });
  })(),
    X(),
    Y();
