          ...
          <div class="container">
            <div class="cart-notification__wrapper">
              ...
              <div class="cart-notification__text-wrapper">
                ...
                <a href="${window.themeVariables.routes.cartUrl}" data-no-instant aria-controls="mini-cart" aria-label="Cart" class="cart-notification__view-cart link">${window.themeVariables.strings.cartViewCart}</a>
              </div>
