...
$(document).on("productDataLoaded", function () {
  ...
  form
    .find(".quantity-submit-row__submit")
    .css({ display: "flex", margin: "0px" });
  ...
  if ($(".price")[0]) {
    var currentPrice = $(".price")[0].innerHTML;
  }
  if ($(".current-price")[0]) {
  ...
  if ($(".was-price")[0]) {
    ...
    var stickyImageContent =
      `<div class="qsb-product"><div class="qsb-product__media" style="width: 60px;"><img src="` +
      imageLink +
      `" alt="Stone 190"></div><div class="qsb-product__info"><h2 class="qsb-product__title" style="color: rgb(255, 255, 255);">` +
      productTitle +
      `</h2><p class="qsb-product__price"><span class="qsb-product__current-price" style="color: rgb(255, 255, 255);">` +
      currentPrice +
      `</span><s class="qsb-product__price-compare-at" style="background: black; color: #ababab">` +
      wasPrice +
      `</s></p></div></div>`;
  } else {
    var stickyImageContent =
  ...
  var stickyHTML =
    `<div id="qikify-stickycart-app" class="qikify-stickycart-app">
        <div class="qsb-wrapper--mobile-bottom qsb--active in"></div>
        <div class="qsb-wrapper  qsb-wrapper--desktop-bottom  qsb-wrapperr--mobile-bottom  qsb-wrapper--interactive qsb--activee inn"
            ...
            ` +
    stickyImageContent +
    product_list_mobile.get(0).outerHTML +
    product_list_desktop.get(0).outerHTML +
    form.get(0).outerHTML +
    `</div></div>`;
  $("#pagefooter").after(stickyHTML);
  $(".qikify-stickycart-app .quantity-submit-row__submit input").attr(
    "id",
    "sticky_add_to_cart"
  );
  var styleSheet = `<style type="text/css">.qsb-wrapper--mobile-bottom .qsb--active .in{ display: none !important; }.qikify-stickycart-app,.qikify-stickycart-app *,.qikify-stickycart-app:after,.qikify-stickycart-app :after,.qikify-stickycart-app:before,.qikify-stickycart-app :before {    -webkit-box-sizing: border-box;    box-sizing: border-box
    ...
    a.qsc-btn--lg {    line-height: 26px
        ...
        }}@media (max-width:767.98px) {    .qsb-wrapper.qsb-wrapper--mobile-top {        -webkit-transform: translateY(-100%);        transform: translateY(-100%)    }    .qsb-wrapper.qsb-wrapper--mobile-top .qsc-btn--close {        top: 100%    }}@media (max-width:767.98px) {    .qsb-wrapper.inn {        -webkit-transform: translate(0);        transform: translate(0)    }    .qsb-wrapper.inn .qsc-btn--close {        opacity: 1;        visibility: visible
        ...
        }}@media (max-width:991.98px) {    .qsb-wrapperr--mobile-bottom {        top: auto;        bottom: 0
        }}.qsb-wrapper--interactive {    opacity: 0;    visibility: hidden;    -webkit-transition: opacity .3s ease-in;    transition: opacity .3s ease-in
    }.qsb-wrapper--interactive.qsb--activee {    opacity: 1;    visibility: visible
    ...
    }@media (max-width:767.98px) {    .qsb-outstock,    .qsb-unavailable {        width: 100%    }}@media (max-width:991.98px) {    .qsb-wrapper {        display: flex;        flex-direction: row;        justify-content: space-between;        align-items: center;    }}@media (min-width:991.98px) {    .qsb-wrapper {        display: flex;        justify-content: space-between;        align-items: center;    }}@media (min-width: 768px) {   .qsb-product__info span{ color: #ff0000 !important;margin-right: 5px;} .qsb-product__info h2 {        font-size: 20px !important;    }}@media (min-width:1200px) {    .qsb-wrapper {        display: flex;        justify-content: space-between;        align-items: center;    }    .qsb-wrapper .qsb-product {        display: flex;        justify-content: center;        align-items: center;    }    .qsb-product__info h2 {        font-size: 20px !important;    }}.qikify-stickycart-app .prodct_variant li {    margin: 7px 12px 7px 12px !important; border: 1px solid #7e7e7e !important;}@media (max-width: 767.98px) {    .qsb-wrapper .prodct_variant {        display: none;    }    .qsb-wrapper .quantity-submit-row {        margin: 5px 0px;    }}@media (max-width: 767px) {    .qsb-wrapper {        display: flex ;        flex-direction: row ;    }    .qsb-product {        display: flex !important;        align-items: center;        padding: 5px;    }    .qsb-product__info {        display: block !important;        font-size: 13px;        color: #222;    }  .qsb-product__price {display: flex; flex-direction: column;}.qsb-product__price span { height: 18px;line-height:normal; }  .qsb-product__info span {        color: #ff0000 !important;    }    .qsb-product__info .qsb-product__price-compare-at {        font-size: 10px;line-height:normal;    }    .qsb-product__info h2 { font-size: 12px!important;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width: 150px;        }    .qsb-wrapper .quantity-submit-row__submit input[type='submit'] {        padding: 10px 15px;border-radius: 2em;font-size: 14px !important;    }    .qikify-stickycart-app .input-row {        margin: 0px
        }    .qikify-stickycart-app {        position: relative;    }    .qikify-stickycart-app .prodct_variant {        position: absolute;        display: flex;        flex-direction: column;        bottom: 0px;        background: #000;        padding: 0px;        border-radius: 5px;        margin-left: 180px;        margin-bottom: 6px;    }    .qikify-stickycart-app .quantity-submit-row__submit {        margin-right: 10px !important
  ...
  if ($(".qikify-stickycart-app #wk_find_zipcode")) {
    $(".qikify-stickycart-app #wk_find_zipcode").remove();
  }
  $(document).on(
    "click touchstart",
    ".qikify-stickycart-app .veriant_sect",
    function (e) {
      var selected_variant = e.target.title;
      var selected_variant_id = e.target.id;
      $(
        ".qikify-stickycart-app #SingleOptionSelector-0 option:selected"
      ).removeAttr("selected");
      $(".qikify-stickycart-app .original-selector option:selected").removeAttr(
        "selected"
      );

      $(".qikify-stickycart-app #SingleOptionSelector-0 option").each(function (
        count,
        item
      ) {
        if ($(item)[0].value === selected_variant) {
          $(item).attr("selected", "selected");
        }
      });

      $(".qikify-stickycart-app .original-selector option").each(function (
        count,
        item
      ) {
        if ($(item)[0].value === selected_variant_id) {
          $(item).attr("selected", "selected");
        }
      });
  ...
  $(document).on(
    "click touchstart",
    ".qikify-stickycart-app .mobile li",
    function () {
  ...
  $(document).on("variantImageSelected", ".gallery", function (e, data) {
    var variantSrc = data.featured_image.src
      .split("?")[0]
      .replace(/http[s]?:/, "");
    $(".qsb-product__media img").attr("src", variantSrc);
    $(".qikify-stickycart-app .prodct_variant.mobile li").each(function (
      index
    ) {
  ...
  $(".prodct_variant li").on("click touchstart", function (e) {
    if ($(".current-price.theme-money")[0]) {
      setTimeout(() => {
        $(".qsb-product__current-price")[0].innerHTML = $(
          ".current-price.theme-money"
        )[0].innerHTML;
    ...
    setTimeout(() => {
      if ($(".activevar").attr("data-qty") == 0) {
        $("#sticky_add_to_cart").prop("disabled", true);
      } else {
        $("#sticky_add_to_cart").prop("disabled", false);
      }
    }, 20);
  });
  ...
  $(".qikify-stickycart-app .original-selector")
    .find("option")
    .each(function (index) {
      $(this).removeAttr("selected");
      if (
        $(this).text() ===
        $(".qikify-stickycart-app .prodct_variant.mobile .activevar").attr(
          "title"
        )
      ) {
  ...
  $(".slick-slide").each(function () {
    ...
    if ($(this).attr("aria-hidden") === "false") {
      var img_src = $(this)[0].dataset.fullSizeUrl;
      $(".qsb-product__media img")[0].src = "https:" + img_src + '"';
      return;
    }
  });
