...
//         previousScroll = currentScroll;
    ...
    // $('.flickityt4s-enabled .nt_pr').attr('data-t4s-resizeobserver','');geckoShopify.UpdateResizeObserver();
    geckoShopify.UpdateResizeObserver = function(type) {
      ...
      var callback = function (entries) {
        ...
        myVar = setTimeout(function(){ 
          ...
          if ( type == 'slider') {
            $('.products.flickityt4s-enabled').flickityt4s('resize');
          } else {
            $('.products.js_isotope').isotope('layout');
          }
      ...
      // Create an observerIsotope instance linked to the callback function
      var observerResize = new ResizeObserver(callback);
      
      $els.each(function( index ) {
        // Start Resize observing the target node for configured mutations
        observerResize.observe(this);
    ...
    geckoShopify.flickityt4sResposition = function (bl,el) {
      ...
      if (  $('.nt_products_holder.nt_slider').length == 0 || typeof ($.fn.flickityt4s) == 'undefined' ) return;
        ...
        var $grid = el || $('.nt_products_holder.flickityt4s-enabled');
         ...
         $grid.find('.nt_pr:not(.t4s_Observered)').attr('data-t4s-resizeobserver','');geckoShopify.UpdateResizeObserver('slider');
